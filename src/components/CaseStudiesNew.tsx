        ...
        <div className={`transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          ...
          <div
            ...
            <div className="bg-gradient-to-r from-primary to-secondary rounded-2xl p-12 text-white">
              <h3 className="font-serif text-3xl font-bold mb-6">Ready to Transform Your Safety Culture?</h3>
              <p className="text-xl mb-8 max-w-2xl mx-auto leading-relaxed">
                Join industry leaders who have achieved measurable safety improvements with LEOSHe's innovative platform.
              </p>
